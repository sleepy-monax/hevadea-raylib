...
typedef IterationDecision (*HashMapIterationKeyValueCallback)(void *target, void *key, void *value);
bool hashmap_iterate(HashMap *hashmap, void *target, HashMapIterationKeyValueCallback callback);

typedef IterationDecision (*HashMapIterationValueCallback)(void *target, void *value);
bool hashmap_iterate_values(HashMap *hashmap, void *target, HashMapIterationValueCallback callback);
